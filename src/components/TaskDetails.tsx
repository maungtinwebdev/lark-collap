...
const TaskDetails = ({ task, onEdit, onClose }: any) => {
  if (!task) return null;
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white rounded shadow-lg p-8 w-full max-w-md relative">
        ...
        <div className="mb-2 text-sm text-gray-500">Assigned to: {task.assignee}</div>
        <div className="mb-2 text-sm text-gray-500">Due: {task.dueDate}</div>
